...
export default function SignatureForm() {
    ...
    return (
        <div
            className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen px-8 sm:px-20 font-[family-name:var(--font-geist-sans)]">
                        ...
                        <FormField
                            ...
                            render={({field}) => (
                                <FormItem>
                                    <FormControl>
                                        <div className="flex items-center space-x-2">
                                            <Checkbox id="privacy" checked={field.value}
                                                      onCheckedChange={field.onChange}/>
